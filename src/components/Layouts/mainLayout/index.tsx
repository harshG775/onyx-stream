...
export default function MainLayout({ children }: MainLayoutProps) {
    return (
        <>
            <TooltipProvider>
                <header className="sticky top-0 z-50 bg-background text-foreground border-b">
...
const LogoIcon = () => {
    return (
        <Link href="/" className="group cursor-pointer h-9 px-4 py-2 flex items-center rounded-md font-bold text-2xl">
